...
produire localement
  -> stocker localement
  -> utiliser localement en priorité
  -> garder le réseau comme secours quand c’est utile
...
- hangars agricoles photovoltaïques arrivant en fin de contrat ;
...
Ce prototype ne prouve pas la puissance industrielle. Il prouve la structure : source locale, stockage, usage utile, contexte, mesure et trace.
