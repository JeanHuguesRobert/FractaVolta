...
The same logic applies one layer up: a reasoning step is a cognitive packet. A judgment, suspended and serialized as a typed continuation, is a unit of cognitive work that survives across agents, providers, and process boundaries.
