...
## Rôle de VIGILIA dans FractaVolta

Dans FractaVolta, VIGILIA est référencé comme cas d'usage de FractaTera :

- perception territoriale distribuée ;
- signalement humain ;
- balises LoRa ;
- vigilance sans surveillance ;
- coordination sans centre capturable ;
- preuve d'usage avant complexité technique ;
- extension possible au suivi de ressources mobiles.
...
```text
barons-Mariani/vigilia.md
→ document canonique politique, territorial, sécurité, communs, vigilance civique

FractaVolta/tera.md
→ architecture technique générale FractaTera

FractaVolta/vigilia.md
→ alias / pointeur technique vers le canonique
```

Toute modification substantielle de VIGILIA doit être faite dans le document canonique.
