...
*Known directions, not yet written.*

- IEV hardware specification (prototype V0)
- PGN pilot — Tavignano valley, Corte
- Hydraulic CXU formal model (extension of CXU_SPEC)
- Legal framework: water rights as executable constraints (French law)
